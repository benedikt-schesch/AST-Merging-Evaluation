...
def test_merge(merging_method, repo_name, left, right, base):
    ...
    try:
        ...
        try:
            ...
            merge = 6
            runtime = -1
            print(repo_name,merging_method,base,"Exception during merge. Exception:\n",e)
        try:
            if merge == 0:
                merge = (
            ...
            merge = 5
            print(repo_name,merging_method,base,"Exception during testing of the merge. Exception:\n",e)
    except Exception as e: 
        merge = -1
        runtime = -1
        print(repo_name,merging_method,base,"General exception during the handling of the repository. Exception:\n",e)
    if STORE_SCRATCH:
        dst_name = (
            SCRATCH_DIR
            + repo_name
