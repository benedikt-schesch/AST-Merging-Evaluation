...
# This script first downloads the reaper dataset.  It then outputs, to file data/repos.csv, the Java repos with
# more than 10 GitHub stars and a unit_test score of more than 0.25.
