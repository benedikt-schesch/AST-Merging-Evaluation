...
check-merges-reproducibility:
	...
	@tail -n +2 $(CSV_RESULTS) | awk -F, '{print $$1}' | parallel --progress --bar -u --halt now,fail=1 -j 0 'python3 src/python/replay_merge.py --merges_csv $(CSV_RESULTS) -delete_workdir --idx {}'
