...
java -cp ~/research/version-control/AST-Merging-Evaluation-branch-rewrite-find_merge_commits/build/libs/astmergeevaluation-all.jar astmergeevaluation.FindMergeCommits "$OUT_DIR/valid_repos.csv" "$OUT_DIR/merges"
